...
def main():
    ...
    with open(file_list, 'r') as f:
        list_of_videos = [line.rstrip() for line in f.readlines()[:-1]]
    ...
    for vid in list_of_videos:
        with open((join(ground_truth_path, vid)), 'r') as f:
            gt_content = [line.rstrip() for line in f.readlines()[:-1]]

        with open((join(recog_path, vid)), 'r') as f:
            recog_content = [line.rstrip() for line in f.readlines()[:-1]]
